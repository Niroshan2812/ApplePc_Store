...
public class CustomerDto {
    ...
    public CustomerDto(Long customerId, String customerName, String customerAddress, String customerPhone) {
    ...
    public String toString() {
        return "CustomerDto(customerId=" + this.getCustomerId() + ", customerName=" + this.getCustomerName() + ", customerAddress=" + this.getCustomerAddress() + ", customerPhone=" + this.getCustomerPhone() + ")";
    }
}
