...
public class ProductDto {
    ...
    public ProductDto(Long id, String pname, String pDescription, String qtyInstock, Double price) {
        this.id = id;
        this.pname = pname;
    ...
    public String toString() {
        return "ProductDto(id=" + this.getId() + ", pname=" + this.getPname() + ", pDescription=" + this.getPDescription() + ", qtyInstock=" + this.getQtyInstock() + ", price=" + this.getPrice() + ")";
    }
}
